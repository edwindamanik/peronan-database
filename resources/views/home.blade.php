...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('template/template-admin/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
    <!-- iCheck -->
    <link rel="stylesheet"
        href="{{ asset('template/template-admin/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
    <!-- JQVMap -->
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
        href="{{ asset('template/template-admin/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}">
    <!-- Daterange picker -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar elevation-4" style="background-color:#243763;">
            ...
            <a href="#" class="brand-link">
                <img src="{{asset('/source-image/logo-footer.png')}}" alt="SIAPPARA" class="brand-image "
    ...
    <!-- Tempusdominus Bootstrap 4 -->
    <script
        src="{{ asset('template/template-admin/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}">
    </script>
    <!-- Summernote -->
    <script src="{{ asset('template/template-admin/plugins/summernote/summernote-bs4.min.js') }}"></script>
    <!-- overlayScrollbars -->
    <script src="{{ asset('template/template-admin/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js') }}">
    </script>
    <!-- AdminLTE App -->
