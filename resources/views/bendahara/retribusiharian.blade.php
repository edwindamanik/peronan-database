...
@section('content')
    ...
    <main>
        <div class="container-fluid">
            ...
            <button type="button" class="btn " data-toggle="modal" data-target="#myModalex"
        ...
        <div class="modal fade" id="myModalex" tabindex="-1" role="dialog" aria-labelledby="myModalDeleteLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('harian.batal') }}" method="GET">
                            ...
                            <button type="submit" class="btn btn-primary" style="background-color: #243763">Export to
                                Excel</button>
